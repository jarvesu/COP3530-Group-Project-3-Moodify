...
void returnPlaylist(priority_queue <pM, vector<pM>, greater<pM>>* heapPtr, const unordered_map<string, Song>& songs);
...
int main()
{
    ...
    while(runApplication)
    {
        ...
        auto minDistanceIDs = calcHeap(songs, criteria);

        //Print the songs
        //const pair<float, string>* heapPtr, const unordered_map<string, Song>& songs, int arrSize
...
priority_queue <pM, vector<pM>, greater<pM>>* calcHeap(unordered_map<string, Song>& songs_, vector<pair<bool, float>> criteria) 
{
...
void returnPlaylist(const priority_queue <pM, vector<pM>, greater<pM>>* heapPtr, const unordered_map<string, Song>& songs, int arrSize)
{
    //Setup the Table
