...
//Prints out the playlist generated by the heap in a table structure
void returnPlaylist(const pair<float, string>* heapPtr, const int arrSize, const unordered_map<string, Song>& songs)
{
    //Setup the Table
